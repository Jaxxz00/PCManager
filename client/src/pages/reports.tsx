...
import { BarChart3, TrendingUp, Calendar, Download, PieChart, Monitor, Users, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary via-primary/90 to-primary/80 rounded-xl p-6 text-primary-foreground shadow-xl">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-primary-foreground/80 text-lg">Analisi avanzate e insights sull'inventario IT Maori Group</p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="bg-gradient-to-r from-primary/10 to-primary/20 p-4 rounded-lg border border-primary/30">
          <h2 className="text-lg font-semibold text-primary">Dashboard Analytics</h2>
          <p className="text-primary/80">Visualizza metriche dettagliate dell'inventario IT</p>
        </div>
        <div className="flex items-center gap-2">
